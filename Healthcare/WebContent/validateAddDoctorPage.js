...
function validate() {
	...
	if (/[^0-9a-zA-Z\s]/gi.test(username))
	   {  
	 	 alert( "Please enter alphanumeric value for ussername" );
	      document.myForm1.username.focus;
	      return false; 
	   }
	...
	if (/[^0-9a-zA-Z\s]/gi.test(newPassword))
	   {  
	 	 alert( "Please enter alphanumeric value for new password" );
	      document.myForm1.password.focus;
	      return false; 
	   }
	...
	if (/[^0-9a-zA-Z\s]/gi.test(confirmPassword))
	   {  
	 	 alert( "Please enter alphanumeric value for confirm Password" );
	      document.myForm1.cpassword.focus;
	      return false; 
	   }
